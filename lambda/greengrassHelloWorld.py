...
def infinite_infer_run():
    ...
    try:
        ...
        while True:
            ...
            #cv2.rectangle(overlay, (0, 1490), (100, 1566), (211,211,211), -1)
            #opacity = 0.7
            #cv2.addWeighted(overlay, opacity, frame, 1 - opacity, 0, frame)
            ...
            cv2.putText(frame, str(time_stamp), (0, 1500),
            ...
            for obj in top_k:
                ...
                if (time_now >= cooldown) and obj['prob'] > prob_thresh:
                    if bird_number >= bird_hist:
                        bird_number = 1
                    else:
